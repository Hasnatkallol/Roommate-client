...
const Navbar = () => {
  ...
  return (
    <div className=" w-full z-50  bg-gradient-to-r from-blue-600 to-purple-600 text-white fixed px-10">
      <div className="flex  w-11/12 mx-auto  py-3 z-50  bg-gradient-to-r from-blue-600 to-purple-600 text-white   ">
        {/* Left: Logo */}
